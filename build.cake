    ...
    .Does(() =>
{
    ...
    CleanDirectory($"./src/library/Mutty/bin/{configuration}");
});
...
{
    Information("\nCompiling Mutty...");
    DotNetBuild("./Mutty.sln", new DotNetBuildSettings {
...
Task("Test")
    ...
    .Does(() =>
{
    DotNetTest("./Mutty.sln", new DotNetTestSettings
    {
        Configuration = configuration,
        Verbosity = DotNetVerbosity.Minimal,
        NoLogo = true,
...
Task("Package")
    ...
    .Does(context => 
{
    context.DotNetPack($"./Mutty.sln", new DotNetPackSettings {
        Configuration = configuration,
        Verbosity = DotNetVerbosity.Minimal,
        NoLogo = true,
        NoRestore = true,
